...
```{r bulk avg tas, echo=FALSE, fig.dim = c(10,7)} 
tas +
...
```{r bulk avg mg, echo=FALSE, fig.dim = c(10,7)} 
...
```{r bulk avg fe, echo=FALSE, fig.dim = c(10,7)}
...
```{r bulk avg ca, echo=FALSE, fig.dim = c(10,7)} 
...
```{r bulk avg al, echo=FALSE, fig.dim = c(10,7)}
...
```{r bulk avg alti, echo=FALSE, fig.dim = c(10,7)}
...
```{r cr1 bulk - Si/Alk, include=FALSE, fig.dim = c(10,7)}
